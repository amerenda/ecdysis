...
import { Save, Plus, Trash2, Power, Info, AlertTriangle, HelpCircle, Key, Eye, EyeOff } from 'lucide-react'
...
function AgentSetupPanel({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Agent files */}
      <div>
        <label className="text-xs text-gray-500 mb-2 block">Agent Files</label>
